...
iConfigSkill enables automated operations on the H3C Configuration Tool (新华三配置器) web application through Chrome DevTools browser automation. All operations are performed by interacting with the web UI directly.
